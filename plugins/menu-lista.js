...
▶︎ *Registred»* ${user.registered === true ? '*Yes*' : '*No*' + usedPrefix + 'verificar_'}
...
{ header: "Horny", title: "Remember the god whatching", description: "", id: usedPrefix + "horny" },
{ header: "Owner", title: "Owner menu", description: "", id: usedPrefix + "owner" },
{ header: "Animes", title: "List random anime", description: "", id: usedPrefix + "animes" }
  { header: "", title: "List random anime", description: "", id: usedPrefix + "" }
]},
]})
const interactiveMessage = {
body: { text: menu },
footer: { text: wm + ` \n\n *${usedPrefix}xd-7*` },
header: { title: `\n${lenguajeGB['smsConfi2']()} *${user.genero === 0 ? '' : user.genero == 'Ocultado ' ? `🕶️` : user.genero == 'man ' ? `` : user.genero == 'Woman ' ? `` : ''} ${user.registered === true ? user.name : taguser} *`, subtitle: "test4", hasMediaAttachment: false },
